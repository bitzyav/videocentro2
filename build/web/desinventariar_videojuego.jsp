<%-- 
    Document   : desinventariar_videojuego
    Created on : Dec 10, 2020, 6:59:09 PM
    Author     : Bitzy
--%>
...
<html>
    <head>
        ...
        <title>Desinventariar videojuego</title>
    ...
    <body>
        ...
        <form action="InventarioControl">
            ...
            <input class="button" type="submit" name="accion" value="Desinventariar"/>
        </form>
    </body>
</html>
